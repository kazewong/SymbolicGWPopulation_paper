...
This demonstrates a promising pathway to automatically discover interpretable population models in the ever-growing GW catalog.
\end{abstract}
...
so having the relative importance in that form does not provide insight into astrophysics directly. \todo{This makes no sense. Wouldn’t you look at the amplitude?} \kw{PCA is a transformed coordinate that describe the data, I can't look at the amplitude of a PCA component and know exactly what it means astrophysically. You won't report the PCA value in your abstract since it has no physical meaning.}
