...
we can define the \textit{score} of an expression as the slope of the accuracy-complexity curve, equal to:
\begin{equation}
...
Finally, we can construct the \textit{Pareto curve}, defined as:
\begin{equation}
