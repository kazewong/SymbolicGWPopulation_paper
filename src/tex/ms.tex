...
\icmlauthor{Kaze W.K Wong$^\ast$}{flatiron}
\icmlauthor{Miles Cranmer$^\ast$}{princeton}
\end{icmlauthorlist}
...
\begin{figure*}[hbt!]
\includegraphics[width=\textwidth]{figures/Gaussian_m1_fit.pdf}
...
\marginicon{\href{https://github.com/kazewong/SymbolicGWPopulation_paper/blob/main/src/scripts/figure1_subparts.py}{\faGithub}}
